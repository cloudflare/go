...
func certificateRequestInfo(ctx context.Context, certReq *certificateRequestMsgTLS13, vers uint16) *CertificateRequestInfo {
...
func (hs *clientHandshakeStateTLS13) sendClientCertificate() error {
	...
	cri := certificateRequestInfo(hs.ctx, hs.certReq, c.vers)
