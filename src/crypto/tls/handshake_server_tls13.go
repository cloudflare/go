...
func (hs *serverHandshakeStateTLS13) echIsInner() bool {
	return len(hs.clientHello.ech) == 1 && hs.clientHello.ech[0] == 1
}
...
func (hs *serverHandshakeStateTLS13) doHelloRetryRequest(selectedGroup CurveID) error {
	...
	if hs.echIsInner() {
		...
		helloRetryRequest.ech = []byte{0, 0, 0, 0, 0, 0, 0, 0}
	...
	clientHello, err = c.echAcceptOrReject(clientHello, true /* afterHRR */)
	if err != nil {
